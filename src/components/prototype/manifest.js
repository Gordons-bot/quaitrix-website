...
export const heroManifest = {
  ...
  fields: {
    ...
    'ctaPrimary.action': {
      kind: 'select',
      options: ['scrollTo:contact', 'scrollTo:features', 'open:chat'],
  ...
  fields: {
    ...
    items: {
      ...
      itemFields: {
        ...
        icon: {
          kind: 'select',
          options: ['bolt', 'shield', 'dollar', 'star', 'heart', 'check', 'rocket', 'globe'],
          label: 'Icon',
        },
      },
    },
...
export const themeManifest = {
  palette: {
    kind: 'select',
    options: ['indigo', 'blue', 'emerald', 'rose', 'amber', 'violet', 'slate'],
    label: 'Color Palette',
  },
  accent: { kind: 'select', options: ['amber', 'rose', 'emerald', 'violet', 'sky', 'orange'], label: 'Accent Color' },
  headingFont: {
    kind: 'select',
    options: ['sora', 'inter', 'poppins', 'playfair', 'montserrat'],
    label: 'Heading Font',
  },
